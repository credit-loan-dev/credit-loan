...
public class LoanPriceConfigDaoTest extends BaseTest {
	...
	public void testInsert() {
		...
		if(null!=productConfig) {
			...
			loanPriceConfig.setInterestRateForDay(0.0005);
			loanPriceConfig.setPartnerEnable(true);
			loanPriceConfig.setPartnerId("partnerId");
			loanPriceConfig.setPartnerDiscountChargesRateForDay(0.0003);
			...
			loanPriceConfig.setLoanExtensionInterestRateForDay(0.0005);			
			...
			loanPriceConfig.setLoanOverdueInterestRateForDay(0.001);			
